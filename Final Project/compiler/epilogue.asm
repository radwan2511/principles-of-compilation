...
.L_code_ptr_bin_apply_first_loop1:
        assert_pair(rbx)                                 
        push qword SOB_PAIR_CAR(rbx)                 
        inc rdi

        mov rsi, qword SOB_PAIR_CDR(rbx)                 
        mov rbx, qword rsi                               
 
        cmp byte [rbx], T_nil                       
        jne .L_code_ptr_bin_apply_first_loop1               
...
.L_code_ptr_bin_apply_second_loop2:
        cmp rbx, 0
        je .finish_L_code_ptr_bin_apply_end
        mov rdx, qword [rsp + 8 * (rdi + 2)]                   
        mov rcx, qword [rsp + 8 * (rsi + 3)]                  
        mov [rsp  + 8 * (rdi + 2)], qword rcx                   
        mov [rsp  + 8 * (rsi + 3)], qword rdx                    
        ...
        cmp rbx, 0
        jg .L_code_ptr_bin_apply_second_loop2      

.finish_L_code_ptr_bin_apply_end:
